...
export class AlertService {
    ...
    async get(userId: string, alertId: string): Promise<UserAlert> {
        ...
        return <UserAlert>{
            ...
            entries: [
                {
                    uri: "http://www.amazon.com/star-wars",
                ...
                {
                    uri: "http://www.bestbuy.com/star-wars",
                ...
                {
                    uri: "http://www.staples.com/star-wars",
                ...
                {
                    uri: "http://www.toysrus.com/star-wars",
