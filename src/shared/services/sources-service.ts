...
export class SourcesService {
    ...
    static initialize() {
        ...
        SourcesService._sources.push(this.createSource("401 Games", "401games", "https://store.401games.ca/", "rgb(150, 183, 119)"));
        SourcesService._sources.push(this.createSource("Board Game Bliss", "boardgamebliss", "https://www.boardgamebliss.com/", "rgb(122, 70, 14)"));
